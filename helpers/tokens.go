...
// Generate creates a base64 encoded token
...
// Validate validates a base64 encoded token
func (r *ModelToken) Validate(token string) error {
	...
	log.Debugf("Comparing decodedToken: %s with secret %s", decodedToken, string(str))
